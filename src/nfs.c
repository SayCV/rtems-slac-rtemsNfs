/* $Id: nfs.c,v 1.49 2008/04/24 21:45:04 guest Exp $ */
...
entry	dummy;
	...
	fprintf(stderr,"This is RTEMS-NFS Release $Name: R_rtems_nfs_1_7 $\n");
	fprintf(stderr,"($Id: nfs.c,v 1.49 2008/04/24 21:45:04 guest Exp $)\n\n");
