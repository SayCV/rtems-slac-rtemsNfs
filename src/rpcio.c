/* $Id: rpcio.c,v 1.44 2008/04/29 15:49:05 strauman Exp $ */
...
struct sockwakeup	wkup;
	...
	fprintf(stderr,"This is RTEMS-RPCIOD Release $Name: R_rtems_nfs_1_7 $\n");
	fprintf(stderr,"($Id: rpcio.c,v 1.44 2008/04/29 15:49:05 strauman Exp $)\n\n");
